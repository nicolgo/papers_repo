...
class ModelMeanType(enum.Enum):
    ...
    PREVIOUS_X = enum.auto()  # the model predicts mean
...
class GaussianDiffusion:
    def __init__(
        ...
        self.alphas_cumprod_pre = np.append(1.0, self.alphas_cumprod[:-1])
        ...
        # x_t = sqrt_alpha_bar * x_0 + sqrt(1 - alpha_bar) * epi
        # => x_0 = (x_t - sqrt(1 - alpha_bar) * epi)/sqrt_alpha_bar
    ...
    def _predict_xstart_from_xprev(self, x_t, t, xprev):
        """ calculate x_0 based on mean and x_t"""
        return (
    ...
    def p_mean_variance(self, model, x, t, clip_denoised=True, denoised_fn=None, model_kwargs=None):
        ...
        # step1: calculate variance and log_variance
        if self.model_var_type in [ModelVarType.LEARNED, ModelVarType.LEARNED_RANGE]:
            ...
            if self.model_var_type == ModelVarType.LEARNED:
                ...
                # exp(v*log_beta_t+(1-v)*log_beta~_t)
