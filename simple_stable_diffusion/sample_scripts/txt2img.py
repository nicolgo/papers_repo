            ...
            with model.ema_scope():
                ...
                for n in trange(opt.n_iter, desc="Sampling"):
                    for prompts in tqdm(data, desc="data"):
                        ...
                        samples_ddim, _ = sampler.sample(S=opt.ddim_steps, conditioning=c, batch_size=opt.n_samples,
...
def get_parser():
    ...
    parser.add_argument("--ddim_steps", type=int, default=5, help="number of ddim sampling steps", )
    ...
    parser.add_argument("--ckpt", type=str, default="../models/ldm/text2img256/sd-v1-4.ckpt",
