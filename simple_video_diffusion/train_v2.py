...
if __name__ == "__main__":
    ...
    diffusion = GaussianDiffusion(model, image_size=64, num_frames=10, timesteps=1000,  # number of steps
                                  loss_type='l1'  # L1 or L2
                                  ).cuda()

    trainer = VideoTrainer(diffusion, "D:/ssd/nicol/papers_repo/simple_video_diffusion/data/ucf101",
                           train_batch_size=2, train_lr=1e-4, save_and_sample_every=1000, train_num_steps=700000,
