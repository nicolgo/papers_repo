...
if __name__ == "__main__":
    ...
    dataset = VideoDataset(data_path, sequence_length=16, train=True, resolution=128)
    dataloader = torch.utils.data.DataLoader(dataset, batch_size=1, num_workers=0, pin_memory=True, shuffle=True)
    ...
    try:
        while i < 10000:
            ...
            trainer = ImagenTrainer(imagen, checkpoint_path=logdir, checkpoint_every=2)
