...
if __name__ == "__main__":
    ...
    imagen = ElucidatedImagen(unets=(unet1, unet2), image_sizes=(16, 32), random_crop_sizes=(None, 16),
                              condition_on_text=False, num_sample_steps=10, cond_drop_prob=0.1, sigma_min=0.002,  # min noise level
    ...
    try:
        while i < 100:
            ...
            trainer = ImagenTrainer(imagen, checkpoint_path="./logs", checkpoint_every=20)
