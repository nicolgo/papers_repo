...
x = torch.randn(1, 64, 10, 64, 64)
attn_dim_head = 32
spatial_attn = EinopsToAndFrom('b c f h w', 'b f (h w) c', Attention(64, heads=8))
temporal_attn = lambda dim: EinopsToAndFrom('b c f h w', 'b (h w) f c', Attention(dim=64, heads=8, dim_head=attn_dim_head))
x = spatial_attn(x)
x = temporal_attn(x)
pass
