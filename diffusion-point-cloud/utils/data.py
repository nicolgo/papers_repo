...
def get_train_val_test_loaders(dataset, train_ratio, val_radio, train_batch_size, val_test_batch_size, num_workers):
    train_set, val_set, test_set = get_train_val_test_datasets(dataset, train_ratio, val_radio)
